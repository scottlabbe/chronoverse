...
const sections = [
    {
        ...
        body: (
            <>
                <p>
                    This Privacy Policy explains how ChronoVerse LLC ("ChronoVerse",
            ...
            <>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        details. ChronoVerse never stores your anything related to 
    ...
    },
    {
        ...
        body: (
            <>
                ...
                <ul>
                    <li>Operate, maintain, and improve ChronoVerse;</li>
    ...
    },
    {
        ...
        body: (
            <>
                <p>
                    ChronoVerse employs administrative, technical, and physical
        ...
        body: (
            <>
                <p>
                    ...
                    {" "}
                    <a href="mailto:privacy@chronoverse.app">privacy@chronoverse.app</a>
                    {" "}
                    or write to ChronoVerse LLC, 600 Stewart Street, Suite 400,
...
export default function Privacy() {
    return (
        <LegalLayout
            ...
            description="Learn how ChronoVerse collects, uses, and protects your information when you explore the minute-by-minute poetry stream."
