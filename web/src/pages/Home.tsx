...
export default function Home() {
  ...
  const primaryCtaLabel = authedEmail ? "Continue in ChronoVerse" : "Start free";
  ...
  async function handleSendLink(event: React.FormEvent) {
    ...
    try {
      ...
      setStatus("Check your inbox for a magic link to ChronoVerse.");
      setEmail("");
    } catch (err: any) {
  ...
  return (
    <>
      <a className="home-skip-link" href="#chronoverse-main">
      ...
      <div className={`home-landing ${alignClass}`} style={heroStyle}>
        ...
        <main className="home-shell home-main" id="chronoverse-main">
          <section className={`home-hero-cluster ${alignClass}`}>
            <header className={`home-hero-heading ${alignClass}`}>
              ...
              <p className="home-hero-description">
                ChronoVerse keeps time with language—opening a new stanza at every
            ...
            >
              <div className="home-sampler-heading">
                ...
                <p>
                  Browse a rotating reel of sample poems inspired by ChronoVerse
