...
const sections = [
    {
        ...
        body: (
            <>
                <p>
                    The Present Verse is a creative writing experience that reveals a new
    ...
    },
    {
        ...
        body: (
            <>
                <p>
                    The Present Verse currently offers a limited free exploration window
        ...
        body: (
            <>
                ...
                <ul>
                    ...
                    sharing The Present Verse output in a misleading way;</li>
                    ...
                    permitted in writing by The Present Verse.</li>
                </ul>
                <p>
    ...
    },
    {
        ...
        body: (
            <>
                <p>
                    The Present Verse retains ownership of the Services, including the
    ...
    },
    {
        ...
        body: (
            <>
                <p>
                    The Present Verse creates poems and prompts with the help of machine
                    ...
                    using any The Present Verse output responsibly and in accordance with
                    applicable laws.
                </p>
                <p>
        ...
        body: (
            <>
                <p>
                    ...
                    you grant The Present Verse a perpetual, irrevocable license to use the
    ...
    },
    {
        ...
        body: (
            <>
                <p>
                    The Present Verse is provided "as is" and "as available" without
    ...
    },
    {
        ...
        body: (
            <>
                <p>
                    To the fullest extent permitted by law, The Present Verse and its
                    ...
                    the amount you paid to The Present Verse in the twelve months before
                    the claim arose.
                </p>
            </>
        ),
    },
    {
        ...
        body: (
            <>
                <p>
                    You agree to indemnify and hold The Present Verse and its affiliates
        ...
        body: (
            <>
                <p>
                    ...
                    the product. Your continued use of The Present Verse after changes take
...
export default function Terms() {
    return (
        <LegalLayout
            ...
            description="These terms explain how you may use the The Present Verse experience and what you can expect from us."
